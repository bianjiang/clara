...
public class ProtocolEmailDataServiceTest {
	...
	public void sendEmail() throws Exception {
		...
		User currentUser = userDao.findById(19l);

		ProtocolForm protocolForm = protocolFormDao.findById(17918l);
		...
		//protocolEmailService.sendLetter(protocolForm, Committee.IRB_REVIEWER, null, currentUser, "NEW_SUBMISSION_FULL_BOARD_APPROVE_TO_PBS", "", "Reportable New Information Full Board Acknowledgement Letter", "Reportable New Information Full Board Acknowledgement Letter", "[{\"address\":\"GROUP_studyPI\",\"type\":\"GROUP\",\"desc\":\"Study PI and Staffs\"}]", "");
