...
@ContextConfiguration({"file:src/test/java/edu/uams/clara/webapp/protocol/web/ajax/ProtocolListAjaxControllerTest-context.xml"})
public class ProtocolListAjaxControllerTest {
	...
	public ProtocolListAjaxController getProtocolListController() {
		return protocolListAjaxController;
	}
}
