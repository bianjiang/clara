function renderSummaryPage(formXmlDataId){
	...
	initializeStaffStores(formXmlDataId);
	initializeSitesStores(formXmlDataId);
	renderSites(formXmlDataId);
	renderStaff(formXmlDataId);
...
function renderSites(formXmlDataId){
...
function renderStaff(formXmlDataId){
