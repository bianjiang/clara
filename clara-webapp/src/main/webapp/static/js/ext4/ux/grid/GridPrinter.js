...
Ext.define("Ext.ux.grid.Printer", {
    ...
    statics: {
        ...
        print: function(grid, featureId) {
            ...
            var customStyleSheetPathsHTML = "";
            for (var i=0,l=this.customStylesheetPaths.length;i<l;i++){
            	customStyleSheetPathsHTML += '<link href="' + this.customStylesheetPaths[i] + '" rel="stylesheet" type="text/css" media="screen,print" />';
    		}
