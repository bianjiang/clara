...
public class HumanSubjectResearchDeterminationValidationRuleInitiator implements ValidationRuleInitiator {

	private final static Logger logger = LoggerFactory
	.getLogger(HumanSubjectResearchDeterminationValidationRuleInitiator.class);
	...
	public List<Rule> initValidationRules(){		
		...
		String fullPath = validationXmlPath + "/" + "hsrdValidation.xml";
