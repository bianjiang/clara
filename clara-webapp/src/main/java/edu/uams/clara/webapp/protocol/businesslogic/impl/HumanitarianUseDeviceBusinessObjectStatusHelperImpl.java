...
public class HumanitarianUseDeviceBusinessObjectStatusHelperImpl  extends
ProtocolBusinessObjectStatusHelper {
	private final static Logger logger = LoggerFactory
			.getLogger(HumanitarianUseDeviceBusinessObjectStatusHelperImpl.class);
	
	public HumanitarianUseDeviceBusinessObjectStatusHelperImpl()
