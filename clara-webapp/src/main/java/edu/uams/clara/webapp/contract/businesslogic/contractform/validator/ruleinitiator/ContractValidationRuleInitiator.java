package edu.uams.clara.webapp.contract.businesslogic.contractform.validator.ruleinitiator;
...
public class ContractValidationRuleInitiator implements ValidationRuleInitiator {


	private final static Logger logger = LoggerFactory
	.getLogger(ContractValidationRuleInitiator.class);
	...
	public List<Rule> initValidationRules(){		
		...
		String fullPath = validationXmlPath + "/" + "newContractValidation.xml";
