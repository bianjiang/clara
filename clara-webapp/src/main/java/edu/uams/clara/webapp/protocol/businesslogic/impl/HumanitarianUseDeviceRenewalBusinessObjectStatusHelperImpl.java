...
public class HumanitarianUseDeviceRenewalBusinessObjectStatusHelperImpl  extends
ProtocolBusinessObjectStatusHelper {
	private final static Logger logger = LoggerFactory
			.getLogger(HumanitarianUseDeviceRenewalBusinessObjectStatusHelperImpl.class);
	
	public HumanitarianUseDeviceRenewalBusinessObjectStatusHelperImpl()
