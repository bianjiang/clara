...
public class ContractSearchCriteria extends AbstractSearchCriteria {
	...
	public static enum ContractSearchField{
		IDENTIFIER, TITLE, PI_NAME, CONTRACT_STATUS, STAFF_NAME, CONTRACT_TYPE, ENTITY_NAME, PROTOCOL_ID, STAFF_USERID, PI_USERID, ASSIGNED_REVIEWER_USERID, CONTRACT_ADMIN_USERID, CONTRACT_LEGAL_REVIEW_USERID;
	}
