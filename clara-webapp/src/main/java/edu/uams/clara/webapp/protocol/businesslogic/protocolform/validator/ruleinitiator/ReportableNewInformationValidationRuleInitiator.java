...
public class ReportableNewInformationValidationRuleInitiator implements ValidationRuleInitiator {

	private final static Logger logger = LoggerFactory
	.getLogger(ReportableNewInformationValidationRuleInitiator.class);
	...
	public List<Rule> initValidationRules(){		
		...
		String fullPath = validationXmlPath + "/" + "reportableNewInfoValidation.xml";
