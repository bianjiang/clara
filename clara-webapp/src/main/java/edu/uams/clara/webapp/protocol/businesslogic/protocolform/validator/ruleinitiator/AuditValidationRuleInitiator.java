...
public class AuditValidationRuleInitiator implements ValidationRuleInitiator {
	private final static Logger logger = LoggerFactory
			.getLogger(AuditValidationRuleInitiator.class);
	...
	public List<Rule> initValidationRules(){		
		...
		String fullPath = validationXmlPath + "/" + "auditValidation.xml";
