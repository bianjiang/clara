...
public class ContinuingReviewValidationRuleInitiator implements ValidationRuleInitiator {
	private final static Logger logger = LoggerFactory
			.getLogger(ContinuingReviewValidationRuleInitiator.class);
	...
	public List<Rule> initValidationRules(){		
		...
		String fullPath = validationXmlPath + "/" + "continuingReviewValidation.xml";
