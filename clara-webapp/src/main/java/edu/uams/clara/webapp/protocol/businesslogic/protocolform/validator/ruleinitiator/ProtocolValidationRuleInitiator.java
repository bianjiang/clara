...
public class ProtocolValidationRuleInitiator implements ValidationRuleInitiator {


	private final static Logger logger = LoggerFactory
	.getLogger(ProtocolValidationRuleInitiator.class);
	...
	public List<Rule> initValidationRules(){		
		...
		String fullPath = validationXmlPath + "/" + "newSubmissionValidation.xml";
