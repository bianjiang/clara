...
public class StudyClosureValidationRuleInitiator implements ValidationRuleInitiator {
	private final static Logger logger = LoggerFactory
			.getLogger(StudyClosureValidationRuleInitiator.class);
	...
	public List<Rule> initValidationRules(){		
		...
		String fullPath = validationXmlPath + "/" + "studyClosureValidation.xml";
