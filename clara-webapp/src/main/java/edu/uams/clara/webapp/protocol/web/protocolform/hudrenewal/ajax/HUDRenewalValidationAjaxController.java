package edu.uams.clara.webapp.protocol.web.protocolform.hudrenewal.ajax;
...
@Controller
public class HUDRenewalValidationAjaxController {
	
	private final static Logger logger = LoggerFactory
	.getLogger(HUDRenewalValidationAjaxController.class);
	...
	@RequestMapping(value = "/ajax/protocols/{protocolId}/protocol-forms/{protocolFormId}/humanitarian-use-device-renewal/protocol-form-xml-datas/{protocolFormXmlDataId}/validate", method = RequestMethod.GET)
	public @ResponseBody
	List<ValidationResponse> validateHUDRenewalForm(
		...
		if(StringUtils.hasText(xmldata)){
			...
			List<Rule> protocolValidationRules = getValidationRuleContainer().getValidationRules("hudRenewalValidationRules");

			Assert.notNull(protocolValidationRules);

			Set<String> valueKeys = getValidationRuleContainer().getCachedValueKeys("hudRenewalValidationRules");
